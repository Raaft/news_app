...
class FaceBookFeedsScreen extends StatefulWidget {
  const FaceBookFeedsScreen({Key key}) : super(key: key);

  @override
  _FaceBookFeedsScreenState createState() => _FaceBookFeedsScreenState();
}

class _FaceBookFeedsScreenState extends State<FaceBookFeedsScreen> {
  var time =
